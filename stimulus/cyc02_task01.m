...
save_directory = fullfile('..','data','cyc02',save_file_name);

% #########################################################################

% KEY PARAMETERS
vel_coeffs_base = [.05 .1 .15 .3 .4 .5 .8 1 1.2 1.4 5 10];
% vel_coeffs_base = .05 * ones(1,7);
phase_shift_base = [180, 360];
n_tr_per_cnd = 3;  % must be an even number
